  ...
  try {
    ...
    const profileData = {
      ...
      enrollment: {
        ...
        age: enrollment ? enrollment.age : '',
        birthdate: enrollment ? enrollment.age : '',
        gender: enrollment ? enrollment.gender : '',
        mothername: enrollment ? enrollment.mothername : '',
        fathername: enrollment ? enrollment.fathername : '',
        guardian_contact: enrollment ? enrollment.guardian_contact : '',
        address: enrollment ? enrollment.address : '',
        elemschool: enrollment ? enrollment.elemsschool : '',
        juniorschool: enrollment ? enrollment.juniorschool : '',
        seniorschool: enrollment ? enrollment.seniorschool : '',
      },
    };
